...
| raccoon --proxy http://127.0.0.1:8080 <target.com>                                      | Scans the entire target using the specified proxy for routing. This comes handy when you want to route your communication through burpsuite, or any other tool used for pentesting. 	      	       		         |   
|                                                                                         | 															                                                                                                                                                                                   |
